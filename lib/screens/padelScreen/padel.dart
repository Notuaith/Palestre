...
import 'package:palestre/screens/padelConferma/padelConferma.dart';
...
class _CalcettoState extends State<Padel> {
  String date = "";
            ...
            children: [
              Container(
                ...
                child: Column(
                  children: [
                    Padding(
                      padding: const EdgeInsets.only(top: 250, left: 14),
                      child: Row(
                        children: const [
                          Text(
                            "Prenotazione Padel",
